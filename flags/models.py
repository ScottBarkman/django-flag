...
class FlaggedContent(models.Model):
    ...
    creator = models.ForeignKey(User, related_name="flagged_content", blank=True, null=True) # user who created flagged content -- this is kept in model so it outlives content
